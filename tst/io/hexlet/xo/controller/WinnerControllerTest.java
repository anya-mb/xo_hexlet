...
public class WinnerControllerTest {
    ...
    @Test
    public void testGetWinnerWhenWinnerDiagonalInversed() throws Exception {
        final Field field = new Field(3);
        final WinnerController winnerController = new WinnerController();
    ...
    @Test
    public void testGetWinnerWhenNoWinnerDiagonalInversed() throws Exception {
        final Field field = new Field(3);
        final WinnerController winnerController = new WinnerController();
    ...
    @Test
    public void testGetWinnerWhenNoWinnerDiagonalInversed2() throws Exception {
        final Field field = new Field(3);
        final WinnerController winnerController = new WinnerController();
